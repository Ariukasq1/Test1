  ...
  render() {
    return (
      <Layout>
        ...
        <div className="about-us-standard pt-150 pb-100">
  				<div className="container">
  					<div className="theme-title-three text-center mb-120">
  						<h2 className="title">Хэрэглэгчидтэй харилцах, борлуулалтыг дэмжих, маркетингийн автоматжуулалтын платформ</h2>
  					</div>

						<div className="row">
							<div className="col-lg-6">
								<div className="single-block" data-aos="fade-up">
									<h5 className="block-title pb-30">Бидний түүх</h5>
                ...
                эрксис нь хэрэглэгчидтэй харилцах хязгааргүй олон сувгийг нэг дор нэгтгэж, хэрэглэгчидтэй харилцах алба хэлтсүүдийн үйл ажиллагааг дэмжиж, хоорондын уялдаа холбоог сайжруулах, үнэнч хэрэглэгчдээ бөөцийлөх, шинэ хэрэглэгчдэд борлуулалтын сэжим үүсгэх, харилцагчийн үйлчилгээг сайжруулах нээлттэй эхийн систем юм.</p></div>
							...
							<div className="col-lg-6">
								<div className="single-block" data-aos="fade-up">
									<h5 className="block-title pb-30">Бид хэн бэ</h5>
        ...
        <div className="video-action-banner-one mt-95">
          <div className="overlay">
            <a data-fancybox href="https://www.youtube.com/embed/sIDKdBjBCCc" className="video-button fancybox"><img src="images/icon/icon47.svg" alt="" /></a>
          </div>
        </div>
      </Layout>
    )
