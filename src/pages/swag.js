      ...
      <Layout>
        <div className="our-service pt-200 pb-100">
                ...
                <div className="col-lg-6 order-lg-first">
                  ...
                  <div className="icon-box mb-20"><img className="icon" src="images/icon/icon33.svg" alt=""/></div>
                    ...
                    <ul className="theme-list-item">
                      <li><i className="color-style fa fa-check" aria-hidden="true"></i>Эхний 4 алхмыг бүрэн гүйцэтгэсэн эсэхээ шалгаарай! Бид хүсэлт тус бүртэй нэг бүрчлэн танилцах ба бүх шаардлагыг хангасан тохиолдолд та бэлгээ авах боломжтой.</li>
                      <li><i className="color-style fa fa-check" aria-hidden="true"></i>Илгээмжийг дэлхийн аль ч оронд үнэгүй явуулна</li>
                      <li><i className="color-style fa fa-check" aria-hidden="true"></i>Энэхүү хөтөлбөр нь одоогоор туршилтын шатандаа байгаа бөгөөд ирээдүйд илгээмж явуулах хүрээ, бэлгийн төрөл өөрчлөгдөж магадгүй.</li>
                    </ul>
  								</div>
  							</div>
          ...
          <div className="agn-counter-section">
            ...
            <div className="container">
              <div className="flex">
                <div data-erxes-embed="moR3aE" style={{ width:'600px', height:'800px' }}></div>
              </div>
            </div>
    			</div>
  			</div>
